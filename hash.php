...
#Please make sure that you generate a similar file and store it in the same directory as the code file, for the code to work..

$handleWL = fopen("AllWordListInKali","r");
if ($handleWL) {
